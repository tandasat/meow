...
_Use_decl_annotations_ EXTERN_C void *ExclGainExclusivity() {
...
_Use_decl_annotations_ EXTERN_C void ExclReleaseExclusivity(void *Exclusivity) {
  if (!Exclusivity) {
    return;
  }
...
_Use_decl_annotations_ EXTERN_C static void ExclpRaiseIrqlAndWaitDpc(
    PKDPC Dpc, PVOID DeferredContext, PVOID SystemArgument1,
